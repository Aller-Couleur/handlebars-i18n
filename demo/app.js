...
HandelbarsI18next.configure('en', 'DateTimeFormat', {hour: 'numeric', minute: 'numeric', second: 'numeric', timeZone: 'Australia/Sydney', timeZoneName: 'short'});
HandelbarsI18next.configure('de', 'PriceFormat', {style: 'currency', currency: 'USD'});
HandelbarsI18next.configure('en', 'NumberFormat', { maximumSignificantDigits: 3 });
